...
\recipe{%
	...
	origin = {États-Unis},
	tags = {Végétarien},
	extrainstructioninfo = {Utilisez des bananes très mûres pour cette recette. Idéalement, elles doivent avoir au moins quelques taches brunes. Les bananes trop mûres sont plus sucrées et apportent plus de saveur de banane.},
	ingredients = {
...
\recipe{%
	...
	extrainstructioninfo = {Le pain de la veille fonctionne mieux car il absorbe le mélange de crème sans se désagréger. Le pain brioché ou challah crée le pain perdu le plus luxueux, mais n'importe quel pain tranché épais fera l'affaire.},
	ingredients = {
...
\recipe{%
	...
	extrainstructioninfo = {Pour la meilleure saveur, utilisez du parmesan fraîchement râpé. La vinaigrette peut être préparée jusqu'à 3 jours à l'avance et conservée au réfrigérateur.},
	ingredients = {
...
difficulty = {Débutant},
origin = {Italie},
tags = {Italien, Sans Cuisson, Sans Gluten},
vegetarian = {oui},
extrainstructioninfo = {Utilisez les meilleures tomates que vous pouvez trouver—les variétés anciennes ou mûries sur pied fonctionnent à merveille. La mozzarella di bufala fraîche est traditionnelle et fortement recommandée.},
ingredients = {
...
\recipe{%
	...
	difficulty = {Intermédiaire},
	origin = {États-Unis},
	tags = {Épicé, Poulet, Cuit au Four},
	spicy = {oui},
	extrainstructioninfo = {Pour des ailes extra croustillantes, séchez-les complètement avant l'assaisonnement et assurez-vous qu'elles sont disposées en une seule couche sans se toucher. Servir avec des bâtonnets de céleri et une vinaigrette au fromage bleu ou ranch.},
	ingredients = {
...
\recipe{%
	...
	difficulty = {Débutant},
	origin = {Italie},
	tags = {Pâtes, Viande, Italien, Bolognaise},
...
\recipe{%
	...
	extrainstructioninfo = {Ne retournez pas le saumon trop tôt—attendez qu'il se détache naturellement des grilles du gril. Le poisson doit être opaque et se défaire facilement lorsqu'il est cuit.},
	ingredients = {
...
\recipe{%
	...
	difficulty = {Intermédiaire},
	origin = {Thaïlande},
	tags = {Thaï, Épicé, Curry, Végétalien},
	vegetarian = {oui},
	spicy = {oui},
	extrainstructioninfo = {La pâte de curry rouge thaï varie en niveau de piquant selon les marques. Commencez avec moins et ajoutez-en au goût. Servir sur du riz jasmin ou des nouilles de riz.},
	ingredients = {
...
\recipe{%
	...
	difficulty = {Avancé},
	origin = {États-Unis},
	tags = {Dessert, Chocolat, Gâteau, Célébration},
	extrainstructioninfo = {Pour de meilleurs résultats, amenez tous les ingrédients à température ambiante avant de commencer. Les couches de gâteau peuvent être préparées la veille, enveloppées dans du film plastique et conservées à température ambiante.},
	ingredients = {
...
\recipe{%
	...
	difficulty = {Avancé},
	origin = {États-Unis},
	tags = {Dessert, Tarte, Américain, Automne, Cuit au Four},
	extrainstructioninfo = {Pour une croûte ultra feuilletée, assurez-vous que tous les ingrédients sont froids et manipulez la pâte le moins possible. La tarte peut être préparée la veille et réchauffée avant de servir.},
	ingredients = {
