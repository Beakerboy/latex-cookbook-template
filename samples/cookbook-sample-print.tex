...
\recipe{%
	...
	extrainstructioninfo = {Use overripe bananas for this recipe. Ideally, they have at least a few brown spots. Overripe bananas are sweeter and impart more banana flavor.},
	ingredients = {
...
\recipe{%
	...
	extrainstructioninfo = {Day-old bread works best as it absorbs the custard mixture without falling apart. Brioche or challah bread creates the most luxurious French toast, but any thick-sliced bread will work.},
	ingredients = {
...
\recipe{%
	...
	origin = {Mexico/USA},
	tags = {Salad, Classic},
	extrainstructioninfo = {For the best flavor, use freshly grated Parmesan cheese. The dressing can be made up to 3 days ahead and stored in the refrigerator.},
	ingredients = {
...
difficulty = {Beginner},
origin = {Italy},
tags = {Italian, No-Cook, Gluten-Free},
vegetarian = {yes},
extrainstructioninfo = {Use the best quality tomatoes you can find—heirloom or vine-ripened varieties work beautifully. Fresh mozzarella di bufala is traditional and highly recommended.},
ingredients = {
...
\recipe{%
	...
	difficulty = {Intermediate},
	origin = {USA},
	tags = {Spicy, Chicken, Baked},
	spicy = {yes},
	extrainstructioninfo = {For extra crispy wings, pat them completely dry before seasoning and make sure they're arranged in a single layer without touching. Serve with celery sticks and blue cheese or ranch dressing.},
	ingredients = {
...
\recipe{%
	...
	extrainstructioninfo = {Don't flip the salmon too early—wait until it naturally releases from the grill grates. The fish should be opaque and flake easily when done.},
	ingredients = {
...
\recipe{%
	...
	difficulty = {Intermediate},
	origin = {Thailand},
	tags = {Thai, Spicy, Curry, Vegan},
	vegetarian = {yes},
	spicy = {yes},
	extrainstructioninfo = {Thai red curry paste varies in heat level between brands. Start with less and add more to taste. Serve over jasmine rice or rice noodles.},
	ingredients = {
...
\recipe{%
	...
	extrainstructioninfo = {For best results, bring all ingredients to room temperature before starting. The cake layers can be made a day ahead, wrapped in plastic wrap, and stored at room temperature.},
	ingredients = {
...
\recipe{%
	...
	difficulty = {Advanced},
	origin = {USA},
	tags = {Dessert, Pie, American, Fall, Baked},
	extrainstructioninfo = {For the flakiest crust, make sure all ingredients are cold and handle the dough as little as possible. The pie can be made a day ahead and reheated before serving.},
	ingredients = {
